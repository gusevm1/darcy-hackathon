...
_SEED_COMMENTS: list[dict[str, object]] = [
    # ── Stage 1: Pre-Consultation (all resolved — stage complete) ──
    ...
    # ── Stage 2: Application Preparation (active review) ──
    ...
    {"id": "ehp-040", "document_id": "banking-2-3", "author": "Thomas Müller", "role": "applicant", "content": "Draft delegation matrix uploaded as Appendix A v0.9. Includes thresholds: credit decisions (exec up to CHF 500K, Board above), investment decisions (exec up to CHF 200K), contractual commitments (exec up to CHF 100K annual value). Please review.", "timestamp": "2025-09-28T11:00:00Z", "resolved": False},
    {"id": "ehp-041", "document_id": "banking-2-3", "author": "A. Weber", "role": "finma-reviewer", "content": "Draft delegation matrix received. Thresholds appear reasonable. Will review in detail and provide feedback within one week.", "timestamp": "2025-09-29T14:00:00Z", "resolved": False},
    ...
    {"id": "ehp-042", "document_id": "banking-2-6", "author": "Dr. S. Keller", "role": "consultant", "content": "We acknowledge the gap in Dr. Meier's dossier. Two remediation options under consideration: (1) Dr. Meier completes the SAQ/Swiss Banking Association supplementary banking supervisory training certificate (6-week program), or (2) an additional Board member with direct FINMA-supervised institution experience is appointed. We will confirm the chosen approach by 15 October.", "timestamp": "2025-10-03T16:00:00Z", "resolved": False},
    ...
    {"id": "ehp-043", "document_id": "banking-2-8", "author": "Thomas Müller", "role": "applicant", "content": "Section 9 (Climate Risk) has been drafted and incorporated into v1.1 of the framework. It covers climate-related financial risk identification, scenario analysis aligned with FINMA Guidance 01/2024 (physical and transition risks), and integration into the existing stress testing program (Section 8). Section 6.2 now references FINMA Circular 2023/1 explicitly. Revised document uploaded.", "timestamp": "2025-10-16T09:00:00Z", "resolved": False},
    ...
    {"id": "ehp-044", "document_id": "banking-2-9", "author": "Dr. S. Keller", "role": "consultant", "content": "Compliance reporting line updated in ICS v1.1. Section 3.2 now states: 'The Head of Compliance reports directly to the Board of Directors with a functional reporting line to the CEO for day-to-day operations.' Quarterly compliance reports go directly to the Board. Caveat note removed. Updated document uploaded.", "timestamp": "2025-10-14T10:00:00Z", "resolved": False},
    ...
    # ── Stage 3: Formal Submission (early-stage review) ──
    ...
    {"id": "ehp-045", "document_id": "banking-3-1", "author": "A. Weber", "role": "finma-reviewer", "content": "Initial completeness review: Annexes A through H are present. However, Annex I (IT Security Policy) and Annex J (Business Continuity Plan) referenced in Section 9 appear to be missing from the submission package. Please confirm whether these were omitted intentionally or upload the missing annexes.", "timestamp": "2025-11-05T14:30:00Z", "resolved": False},
    {"id": "ehp-031", "document_id": "banking-3-3", "author": "R. Zimmermann", "role": "auditor", "content": "Audit engagement confirmed. KPMG AG, Zurich will serve as regulatory auditor. Independence declaration and audit plan submitted.", "timestamp": "2025-10-28T10:00:00Z", "resolved": True},
    {"id": "ehp-046", "document_id": "banking-3-2", "author": "R. Zimmermann", "role": "auditor", "content": "Notarized articles reviewed. Articles match the draft version previously submitted in Stage 2 (banking-2-2) with the Article 12 amendment as requested by FINMA. Notarization by Dr. Frei (Canton Zurich) is properly executed. No issues identified.", "timestamp": "2025-10-22T11:00:00Z", "resolved": True},
]
# fmt: on
